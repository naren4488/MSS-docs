...
| `Ajay` | Dual: money ledger + Everest Solar Bill | **+3,21,500** / +77,781 bills | ✅ Wired in Ajay analytics |
...
Dual layout on tab **`Ajay`** — **two side-by-side tables** (live sheet as of 2026-09-05):

| Block | Columns | Title | Headers | Balance |
|-------|---------|-------|---------|---------|
| Left | A–E | Money ledger | Date · DR · CR · Closing Balance · Remark | **+₹3,21,500** |
| Right | K–P | Everest Solar Bill | DATE · INVOICE NO. · DR · CR · Closing Balance · Remark | **₹77,781** |

**Left — money ledger:** PP / CASH collections from Ajay (CR); MSS payments / NEFT out (DR). Totals in row 1: DR **₹11,10,000** · CR **₹7,88,500** · closing **+₹3,21,500** *(+ = we will receive)*.
...
| 25 Aug 2026 | 2,00,000 | — | +21,500 | EVEREST BUILD SOLAR NEFT |
| **05 Sep 2026** | **3,00,000** | — | **+3,21,500** | *(blank remark on sheet)* |

**Right — Everest Solar Bill:** MSE invoices (DR only). Twelve invoices when read:
...
| MSE/26-27/0141 | 2,655 | 71,834 |
| MSE/26-27/0157 | 1,982 | 73,816 |
| **MSE/26-27/0179** | **3,965** | **77,781** |

**Removed:** middle **site commission** block (columns I–O, ~₹1,000/KW per site, was +₹31,000) — no longer on the live tab.

Links to Projects register **`Ajay (everest)`**. Money-ledger rows seeded in `partner-mss-payments.ts` (incl. Aug–Sep 2026 NEFT). Wired in `ajay-sub-vendor-ledger.ts`.
...
### 2026-09-05 — Ajay money + Everest bills refresh

- Live re-read Sub Vendor `Ajay`: new DR **₹3,00,000** on **05 Sep 2026** → closing **+₹3,21,500** (was +₹21,500). Header DR **₹11,10,000**.
- 25 Aug ₹2L remark filled: **EVEREST BUILD SOLAR NEFT**.
- New Everest invoice **MSE/26-27/0179** ₹3,965 (01 Sep) → bills **₹77,781**.
- App seeds updated: `ajay-sub-vendor-ledger.ts`, `AJAY_SUB_VENDOR_LEDGER`, `partner-mss-payments.ts`.
