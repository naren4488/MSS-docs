...
function defaultTerms(): QuotationTermItem[] {
  return [
    ...
    term(
      ...
      "Payment schedule depends on the financing method:\n\n━ 100% CASH PAYMENT\n  • Advance: 20% with order confirmation\n  • 2nd Payment: 70% before material dispatch & installation begins\n  • Final Payment: 10% after installation & system commissioning\n\n━ 100% LOAN FINANCING\n  • Installation work begins immediately upon receipt of first loan installment from bank\n  • Subsequent payments follow bank's loan disbursement schedule\n  • Installation completion not dependent on remaining loan tranches\n\n━ HYBRID (LOAN + CASH MIX)\n  • 1st Installment: Loan amount + customer's cash contribution received before installation begins\n  • 2nd Payment: Only this payment remains pending post-installation\n  • Maximum Cash Limit: Customer's cash contribution should not exceed 10% of total project cost\n\n━ IMPORTANT NOTE\n  • In ALL payment methods, maximum upfront cash payment cannot exceed 10% of total project value\n  • Once required initial payment is received, installation work commences immediately",
    ),
    term(
