...
export const bhanuDCRINA: QuotationData = normalizeQuotationData({
  ...
  materialItems: [
    ...
    { id: "4", description: "AC Cable", qty: "Upto 50", unit: "Mtr", make: "4 Core Aluminium Armoured Cable (3 Phase)" },
    ...
    { id: "7b", description: "Earthing Wire", qty: "Upto 100", unit: "Mtr", make: "16 sq mm aluminium wire or 6 sq mm CCA wire" },
