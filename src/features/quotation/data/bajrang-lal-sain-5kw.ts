...
export const bajrangLalSain5kwQuotation: QuotationRecord = {
  id: "q-bajrang-lal-sain-5kw-001",
  name: "Bajrang Lal Sain - 5KW 1PH",
  ...
  content: {
    ...
    coverImageUrl: "",
    customerName: "Bajrang Lal Sain",
    capacity: "5 KW 1PH",
    systemPhase: "1 Phase",
    phase: "1PH",
    address: "P No 226 Shiv Nagar A, Harnathpura",
    ...
    materialItems: [
      {
        ...
        qty: "9 Panel",
        unit: "590 Wp",
        make: "INA Solar Panels / Monocrystalline with 25 Year Warranty",
      },
      {
        id: "mat-002",
        ...
        qty: "1",
        unit: "1 Phase",
        make: "5.5 KW POLYCAB Inverter with 10 Year Warranty",
      },
      {
        id: "mat-003",
      ...
      },
      {
        ...
        qty: "As per Requirement",
        unit: "M",
        make: "2 Core 10 mm Aluminium Armoured Cable (1PH)",
      },
      {
        id: "mat-005",
    ...
    commercialOffer: [
      ...
      },
      {
        ...
        offering: "9 x 590W INA Solar Panels (5.31 KW Total)",
      },
      {
        id: "comm-003",
      ...
      },
      {
        ...
        offering: "Rs. 56.49 / Watt — Net Payable Amount INR 3,00,000/-",
      },
      {
        id: "comm-005",
        parameter: "Customer Net Payable Amount",
        offering: "INR 3,00,000/- (Including Tax)",
      },
    ...
    generation: {
      perDay: "21 Units / Day",
      perMonth: "630 Units / Month",
      perYear: "7560 Units / Year",
      savingPerYear: "₹ 60,480",
    },
    showWarrantyBadges: true,
    warrantySolarPanelYears: "25",
...
• Installation proceeds immediately once 1st bank installment + client's cash contribution are received`,
      ...
      },
      {
        ...
        text: "The quotation covers only the scope mentioned in the Commercial Offer. Any additional work required will be charged separately at Mahi Solar Solution's prevailing rates (minimum ₹3,000 per day for re-work or additional services).",
      },
      {
        id: "term-008",
        label: "Material Safety & Responsibility",
        text: "Mahi Solar Solution is responsible for material safety during transit and up to delivery at the project site. After delivery at the site, the client becomes responsible for the safety and security of all supplied materials.",
      },
      {
        id: "term-009",
        label: "Panel Cleaning & Maintenance",
        text: "For optimal solar system performance, regular cleaning of solar panels once every week or once every 15 days is recommended. Dust and dirt accumulation reduces generation efficiency by 15–25%. The client is responsible for regular cleaning.",
      },
      {
        id: "term-010",
        label: "Electricity Generation & Seasonal Variation",
        text: "Annual energy generation is calculated as 4–4.5 kWh per kW of installed capacity per day on average across the year. Generation varies by season based on weather conditions and daylight hours.",
      },
      {
        id: "term-011",
        label: "Warranty Coverage & Limitations",
        text: "Warranty Coverage:\n• Panels: 25-year product warranty (manufacturing defects) + 25-year performance warranty\n• Inverter: 10-year manufacturer warranty\n• BOS & Installation: 5-year warranty\n\nWarranty WILL NOT Cover damage due to natural disasters, theft, vandalism, fire, improper maintenance, unauthorized modifications, or user negligence.",
      },
      {
        id: "term-012",
        label: "Government Subsidy Dependency",
        text: "Government subsidy under PM Surya Ghar: Muft Bijli Yojana is subject to latest government guidelines and approval by concerned authorities. Subsidy amount and approval timeline are beyond Mahi Solar Solution's control.",
      },
      {
        id: "term-013",
        label: "Jurisdiction & Dispute Resolution",
        text: "This quotation and all related agreements are governed by the laws of Rajasthan, India. All disputes shall be subject to the exclusive jurisdiction of Jaipur Civil Court.",
      },
      {
        id: "term-014",
        label: "Warranty",
        text: "Plant designed for 25 years with linear efficiency. The plant will produce minimum power up to 90% of the rated capacity for 10 years and thereafter 80% of the rated capacity up to 25 years.",
      },
      {
        id: "term-015",
        label: "Photography & Content Creation",
        text: "Mahi Solar Solution reserves the right to conduct photography, video shoots, and content creation during installation for marketing and promotional purposes.",
      },
    ],
    subsidyDocuments: [
      "Aadhar Card",
