...
• Once 1st installment (bank payment + client cash) is received, installation work commences immediately`,
      ...
      {
        id: "term-021",
        label: "Final Payment & Price Finality",
        text: "No discount or revision of the agreed price will be accepted after completion of the work or at the time of final payment.",
      },
      {
        id: "term-022",
        label: "Delayed Payment & Legal Recovery",
        text: "If payment is not received within 21 days of project completion, Mahi Solar Solution Private Limited reserves the right to initiate legal recovery proceedings as permitted under applicable law.",
      },
    ],
    subsidyDocuments: [
      "Aadhar Card",
