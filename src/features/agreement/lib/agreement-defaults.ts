...
/** Includes one-off templates that are not shown in the create picker. */
...
export function getAgreementTemplateLabel(template: AgreementTemplate): string {
  if (template === "management-authority") {
    return "Management Authority & Operational Control";
  }
...
// ---------- Management Authority template ----------

const managementAuthorityVariableFields: AgreementVariableField[] = [
  { key: "mseName", label: "Proprietorship Business Name", helper: "e.g. Mahi Solar Energy" },
  { key: "mseGst", label: "Proprietorship GST" },
  { key: "mobile", label: "Manager Mobile Number" },
  { key: "engagementStart", label: "Engagement Start", helper: "e.g. December 2025" },
  { key: "phase1End", label: "First Phase End", helper: "e.g. February 2026" },
  { key: "phase1Target", label: "First Phase Profit Target", helper: "e.g. ₹10,00,000" },
  { key: "extensionStart", label: "Extended Phase Start", helper: "e.g. March 2026" },
  { key: "targetProfit", label: "Annual Profit Target", helper: "e.g. ₹1.25 Crore" },
  { key: "targetDate", label: "Target Date", helper: "e.g. 31 December 2026" },
  {
    key: "outstandingDebts",
    label: "Current Outstanding Debts (amounts only)",
    helper: "Anonymous amount list, e.g. ₹6,00,000; ₹6,00,000; …",
    multiline: true,
  },
  { key: "outstandingDebtTotal", label: "Total Outstanding Debt", helper: "e.g. ₹43,50,000" },
  { key: "arbitrationVenue", label: "Arbitration Venue", helper: "e.g. Jaipur" },
];

const managementAuthorityVariableDefaults: Record<string, string> = {
...
function createManagementAuthoritySections(): AgreementSection[] {
  return [
    section("Background & Purpose", [
      clause({
        ...
        title: "Background",
        content:
          "The Parties record the following background, which forms an integral part of this Agreement:",
        subPoints: [
          {
            label: "a",
            text: "Until {{var.engagementStart}}, {{company.representativeName}} personally managed substantially all aspects of the Businesses, including funds, decisions, inventory, teams, salaries, bills, clients, sales, transport, planning and day-to-day operations, with a small team.",
          },
          {
            label: "b",
            text: "From {{var.engagementStart}}, {{party.entityName}} and {{company.representativeName}}, being friends, united to address operational problems in the Businesses and to bring growth.",
          },
          {
            label: "c",
            text: "{{party.entityName}} is independently employed as a software engineer and earns a good salary outside the Businesses. {{party.entityName}} initially promised to help {{company.representativeName}} with the Businesses for approximately three months ending {{var.phase1End}}, with a profit target of {{var.phase1Target}}, and undertook not to take a single penny of remuneration from the Businesses for that phase.",
          },
          {
            label: "d",
            text: "During the first phase, {{party.entityName}} infused money into the Businesses from time to time as required and also withdrew amounts when needed. {{party.entityName}} did not demand any fee, salary, commission or profit share for that assistance. Overall, as per {{party.entityName}}'s promise, {{party.entityName}} did not demand money for this help. Any amount taken by {{party.entityName}} from {{company.representativeName}} or the Businesses (then or later) is treated as a loan repayable by {{party.entityName}}.",
          },
          {
            label: "e",
            text: "At the end of {{var.phase1End}}, the Parties reviewed the accounts and confirmed that the first-phase profit target was achieved. {{party.entityName}} had, with {{company.representativeName}}'s permission, taken substantial matters into {{party.entityName}}'s own hands and improved systems, processes and operations that contributed to that result.",
          },
          {
            label: "f",
            text: "In {{var.extensionStart}}, the Parties again sat together and discussed the Businesses. {{company.representativeName}} requested {{party.entityName}} to help even further, including helping the Businesses generate sufficient surplus to (i) repay loans of {{company.representativeName}} and/or {{company.representativeName}}'s family, (ii) enable purchase of a Toyota Hilux vehicle desired by {{company.representativeName}}, and (iii) build a healthy bank balance in personal and/or Business accounts. The Parties calculated / estimated that the Businesses would need to make {{var.targetProfit}} in profit by {{var.targetDate}} for these objectives.",
          },
          {
            label: "g",
            text: "For these efforts, {{company.representativeName}} has given {{party.entityName}} full access to all decisions, all finance and every department and part of the Businesses, with authority to take the Businesses in the right direction, achieve the goals and grow the Businesses. {{party.entityName}} has accepted that responsibility out of friendship and to fulfil {{party.entityName}}'s promise to {{company.representativeName}}, without any partnership and without any pre-agreed monetary deal or profit claim.",
          },
        ],
      }),
    ]),
    section("Nature of Relationship", [
      clause({
        number: "2",
        title: "No Partnership, Employment or Equity",
        content: "The Parties expressly agree that:",
        subPoints: [
          {
            label: "a",
            text: "This Agreement does not create, and shall not be construed as creating, a partnership, joint venture, agency for profit-sharing, or co-ownership between the Parties. Until {{var.targetDate}}, the Parties shall not enter into any partnership, joint venture, profit-sharing agency or co-ownership arrangement with each other in respect of the Businesses. On {{var.targetDate}}, this Agreement shall end automatically — whether or not the profit target under this Agreement is achieved.",
          },
          {
            label: "b",
            text: "If the profit target is not met by {{var.targetDate}}, that is acceptable to both Parties. Missing the target does not create any claim, blame, partnership right, payment right, or continuing management duty after {{var.targetDate}}. Business results will be known in due course. What still remains binding is the loss-cover responsibility under Clause 9.",
          },
          {
            label: "c",
            text: "{{party.entityName}}'s money responsibility is explained in Clause 9. In short: normal Business loans while the Businesses are performing are not automatically {{party.entityName}}'s personal burden. If there are losses such that loans cannot be covered and {{company.representativeName}} would otherwise have to pay, {{party.entityName}} will cover that shortfall under Clause 9, even after this Agreement ends on {{var.targetDate}}, without charging any fee.",
          },
          {
            label: "d",
            text: "{{party.entityName}} is not a partner, shareholder, director or co-owner of {{company.name}} or {{var.mseName}} by reason of this Agreement. {{var.mseName}} is a proprietorship wholly owned by {{company.representativeName}}. {{company.name}} is a private limited company in which {{company.representativeName}} holds approximately 99% and Shri Pal Kumawat ({{company.representativeName}}'s relative — brother-in-law) holds approximately 1%. All ownership and profit rights in the Businesses remain solely with {{company.representativeName}} (and the existing minority shareholding of Shri Pal Kumawat in {{company.name}}).",
          },
          {
            label: "e",
            text: "{{party.entityName}} is not entitled to any salary, wage, retainer, commission, incentive, profit share, equity, sweat-equity or other remuneration from the Businesses under this Agreement. There is no deal for any such payment. Any discretionary goodwill amount that {{company.representativeName}} may later choose to give is entirely voluntary and is not part of any present bargain.",
          },
          {
            label: "f",
            text: "{{party.entityName}} continues to earn livelihood independently as a software engineer and is assisting the Businesses primarily to help a friend and to fulfil {{party.entityName}}'s promise to {{company.representativeName}}. There is no partnership at all between the Parties.",
          },
        ],
      }),
    ]),
    section("Grant of Authority", [
      clause({
        number: "3",
        title: "Full Operational and Financial Authority",
        content:
          "{{company.representativeName}}, as Director of {{company.name}} and Proprietor of {{var.mseName}}, hereby grants {{party.entityName}} full operational and financial authority over the Businesses for the Term — including the right to take decisions and deal with Business money as {{party.entityName}} considers necessary for the Businesses — covering without limitation:",
        subPoints: [
          {
            label: "a",
            text: "Take and implement decisions relating to funds, banking, payments, collections, inventory, procurement, teams, hiring, salaries, bills, clients, sales, transport, planning, vendors, systems and day-to-day management.",
          },
          {
            label: "b",
            text: "Manage and direct every department and function of the Businesses as {{party.entityName}} considers necessary for growth, discipline and achievement of the objectives stated in this Agreement. {{party.entityName}} is managing substantially on {{party.entityName}}'s own and is responsible for directing the Businesses toward growth (and, if losses create an uncovered loan shortfall, for the cover under Clause 9).",
          },
          {
            label: "c",
            text: "Deal with money of the Businesses for business purposes in the ordinary course, subject to Clause 7 (Compensation & Money Movements) and Clause 9 (Unsecured Loans & Loss Responsibility).",
          },
          {
            label: "d",
            text: "This grant reflects {{company.representativeName}}'s trust in {{party.entityName}} — that {{party.entityName}} may do what {{party.entityName}} considers right with the Businesses and Business money for Business purposes. {{party.entityName}} shall exercise the authority in good faith for the benefit of the Businesses and {{company.representativeName}}'s stated objectives, and not for personal enrichment beyond what is expressly permitted in this Agreement.",
          },
        ],
      }),
      clause({
        number: "4",
        title: "Manager's Acceptance of Responsibility",
        content:
          "{{party.entityName}} accepts that, as per {{company.representativeName}}'s ask and {{party.entityName}}'s promise, {{party.entityName}} is now taking most decisions and managing everything substantially on {{party.entityName}}'s own under this grant of authority. Whether the {{var.targetProfit}} target is met is a separate outcome under Clause 2(b). {{party.entityName}}'s money responsibility is not every normal Business loan, but the cover of any loss shortfall under Clause 9, without charging any fee.",
      }),
    ]),
    section("Manager's Ask & Owner's Commitments", [
      clause({
        number: "5",
        title: "Trust, Conduct and Final Decision",
        content:
          "In return for {{party.entityName}}'s unpaid efforts, responsibility and support under this Agreement, {{party.entityName}} has asked for — and {{company.representativeName}} agrees to — the following:",
        subPoints: [
          {
            label: "a",
            text: "Trust: {{company.representativeName}} shall trust {{party.entityName}} throughout this journey and shall continue to repose confidence in {{party.entityName}}'s intentions and efforts for the Businesses.",
          },
          {
            label: "b",
            text: "No scolding or fighting: {{company.representativeName}} shall not scold, abuse, quarrel with or fight with {{party.entityName}} at any point during this journey, even if {{company.representativeName}} feels that {{party.entityName}} has made a mistake. Differences shall be discussed calmly and respectfully as friends.",
          },
          {
            label: "c",
            text: "Final decision: If there is any dispute or difference of opinion on any Business decision during the Term, {{party.entityName}}'s decision shall be final and binding for operational purposes, consistent with the authority granted under Clause 3.",
          },
        ],
      }),
      clause({
        number: "6",
        title: "Owner's Personal Growth & People Care",
        content:
          "{{company.representativeName}} further commits, as part of this shared journey and as requested by {{party.entityName}}, to work on himself and on how people around the Businesses are treated:",
        subPoints: [
          {
            label: "a",
            text: "Soft skills: {{company.representativeName}} shall consciously improve soft skills — including communication, patience, listening, emotional control and respectful behaviour — so as to become a better person in day-to-day dealings.",
          },
          {
            label: "b",
            text: "Fitness: {{company.representativeName}} shall do regular exercise, work toward becoming fitter, and lose weight in a healthy, consistent manner.",
          },
          {
            label: "c",
            text: "Helping good people: {{company.representativeName}} shall, so far as reasonably possible, help good people and support those who act with honesty and goodwill.",
          },
          {
            label: "d",
            text: "Employee care: {{company.representativeName}} shall take care of employees and team members who are helping in this business — with fairness, respect and concern for their well-being — and shall not mistreat those who are contributing to the Businesses.",
          },
        ],
      }),
    ]),
    section("Compensation & Money Movements", [
      clause({
        number: "7",
        title: "No Remuneration; Withdrawals Are Loans",
        content: "Regarding money between {{party.entityName}} and the Businesses / {{company.representativeName}}:",
        subPoints: [
          {
            label: "a",
            text: "{{party.entityName}} shall not charge any fee, salary, commission or other consideration for the services, decisions or efforts under this Agreement.",
          },
          {
            label: "b",
            text: "If {{party.entityName}} takes, receives or withdraws any amount from {{company.representativeName}} or from any Business account or cash for personal use, that amount shall be treated as a loan owed by {{party.entityName}} to the relevant Business / {{company.representativeName}}, and {{party.entityName}} shall repay it.",
          },
          {
            label: "c",
            text: "Amounts previously infused by {{party.entityName}} into the Businesses, and amounts previously withdrawn by {{party.entityName}}, shall be accounted between the Parties in good faith. Nothing in this Agreement converts any such movement into a claim for partnership profit or remuneration.",
          },
          {
            label: "d",
            text: "Any future capital support that {{party.entityName}} may provide to the Businesses shall likewise be recorded as loan / temporary support as the Parties agree in writing or in their books, and shall not create ownership or profit rights.",
          },
        ],
      }),
    ]),
    section("Ownership of Profits & Business Objectives", [
      clause({
        number: "8",
        title: "All Profits Belong to the Owner",
        content: "The Parties agree that:",
        subPoints: [
          {
            label: "a",
            text: "If the Businesses make {{var.targetProfit}} (or any other profit) by {{var.targetDate}} or at any other time, the whole of such profit belongs exclusively to {{company.representativeName}} / the Businesses — nothing of that profit is {{party.entityName}}'s under this Agreement. {{party.entityName}} has no claim over that profit.",
          },
          {
            label: "b",
            text: "The objectives of loan repayment for {{company.representativeName}} / family, purchase of the Toyota Hilux, and building bank balance are {{company.representativeName}}'s personal / Business goals. Achieving them from Business surplus does not create any entitlement for {{party.entityName}}.",
          },
          {
            label: "c",
            text: "If {{company.representativeName}} later wishes to give {{party.entityName}} any amount as goodwill, appreciation or gift, that shall be a separate voluntary act and not a term of this Agreement. No such deal has been made.",
          },
        ],
      }),
    ]),
    section("Unsecured Loans & Loss Responsibility", [
      clause({
        number: "9",
        title: "Business Funding and Manager's Stand on Debts",
        content:
          "The Businesses need to invest to operate and grow; hence the Businesses are raising / may raise funds. Having loans is normal in business. {{party.entityName}}'s responsibility is as follows:",
        subPoints: [
          {
            label: "a",
            text: "As of the Effective Date, the Businesses have approximate outstanding unsecured / known-person debts of about {{var.outstandingDebtTotal}}. This figure is indicative and may vary with interest, repayments and fresh borrowings recorded in the books.",
          },
          {
            label: "b",
            text: "The Businesses may continue to take unsecured loans from known persons for Business purposes. Such loans are intended to be repaid gradually from Business profits. If the Businesses perform with overall net profit (even if below the {{var.targetProfit}} target), having debt is a normal business position and is not by itself {{party.entityName}}'s personal liability.",
          },
          {
            label: "c",
            text: "{{party.entityName}}'s responsibility is that, overall, Business profit and investment combined should be greater than the Business loans (debts). In other words, the Businesses should be able to cover their loans from performance and capital put into the Businesses.",
          },
          {
            label: "d",
            text: "If there are losses such that profit and investment together are not enough to cover the loans, and {{company.representativeName}} would otherwise have to pay those loans personally, then {{party.entityName}} takes full personal responsibility to pay / cover that shortfall and stands between the lenders / creditors and {{company.representativeName}} / the Businesses for that purpose, without charging any fee.",
          },
          {
            label: "e",
            text: "Clause 9(d) is a voluntary assumption of responsibility by {{party.entityName}} toward {{company.representativeName}} arising from friendship and promise. It does not make {{party.entityName}} a partner or owner, and it does not dilute {{company.representativeName}}'s exclusive profit and ownership rights.",
          },
          {
            label: "f",
            text: "The Parties shall keep reasonable records of loans raised, repayments, profits, investment, and any personal payments made by {{party.entityName}} toward any loss shortfall.",
          },
        ],
      }),
    ]),
    section("Term, Records & Confidentiality", [
      clause({
        number: "10",
        title: "Term",
        content:
          "This Agreement is effective from the Effective Date and ends automatically on {{var.targetDate}}, whether or not the profit target is achieved, unless extended or terminated earlier by mutual written consent of the Parties, or terminated earlier by {{company.representativeName}} by written notice if {{company.representativeName}} withdraws the authority granted herein. Ending of this Agreement on {{var.targetDate}} does not release {{party.entityName}} from the loss-shortfall cover under Clause 9(d) for the Term. Failure to meet the profit target is accepted by both Parties as an agreed possible outcome and shall not keep this Agreement alive after {{var.targetDate}}.",
      }),
      clause({
        number: "11",
        title: "Books, Access and Good Faith",
        content:
          "{{party.entityName}} shall maintain or cause to be maintained fair books and records of the Businesses, keep {{company.representativeName}} reasonably informed of material developments when requested, and act honestly and in good faith. {{company.representativeName}} retains ownership of all Business assets, accounts, data, credentials and records.",
      }),
      clause({
        number: "12",
        title: "Confidentiality",
        content:
          "{{party.entityName}} shall keep confidential all non-public information of the Businesses, including financials, client data, vendor terms, passwords and strategies, during the Term and thereafter, and shall use such information only for managing the Businesses under this Agreement.",
      }),
    ]),
    section("General", [
      clause({
        number: "13",
        title: "Entire Understanding; Amendments",
        content:
          "This Agreement records the Parties' understanding regarding management authority, the Manager's ask and Owner's commitments, absence of partnership/remuneration, profit ownership, loan treatment of withdrawals, and loss-shortfall cover for Business loans. It may be amended only by a written instrument signed by both Parties.",
      }),
      clause({
        number: "14",
        title: "Governing Law & Dispute Resolution",
        content:
          "This Agreement is governed by the laws of India. Courts / arbitration at {{var.arbitrationVenue}}, Rajasthan shall have jurisdiction. The Parties shall first attempt amicable settlement as friends before initiating formal proceedings. Operational decision disputes during the Term are governed by Clause 5(c).",
      }),
    ]),
  ];
}

const managementAuthorityGoverningLaw =
  "This Agreement is governed by the laws of India. Subject to amicable settlement, disputes shall be subject to the exclusive jurisdiction of the competent courts / arbitration at {{var.arbitrationVenue}}, Rajasthan.";

const managementAuthorityClosing =
  "IN WITNESS WHEREOF, the Parties have executed this Agreement as of the Effective Date. By signing, {{company.representativeName}} confirms the grant of authority, exclusive ownership of profits, and the Owner's commitments under Clauses 5 and 6 (trust, respectful conduct, final operational decision with {{party.entityName}}, personal growth, fitness, helping good people and employee care); and {{party.entityName}} confirms the absence of partnership/remuneration entitlement, the loan character of any personal withdrawals, and the loss-shortfall cover under Clause 9.";

const managementAuthorityIntroTemplate =
  'THIS MANAGEMENT AUTHORITY AND OPERATIONAL CONTROL AGREEMENT (the "Agreement") is made as of {{effectiveDateFormatted}} (the "Effective Date") by and between:\n\n(1) {{company.representativeName}}, Director of {{company.name}} (GST: {{company.gst}}) and Proprietor of {{var.mseName}} (GST: {{var.mseGst}}) (the "Owner"), for and on behalf of both businesses (collectively, the "Businesses"), with principal place of business at {{company.address}};\n\nAND\n\n(2) {{party.entityName}} (the "{{party.partyLabel}}"), an individual holding PAN {{party.pan}} and Aadhaar {{party.aadhaar}}, mobile {{var.mobile}}, of {{party.address}}.';

const managementAuthorityRecitals = [
  "{{company.representativeName}} controls and operates {{company.name}} (Private Limited; approximately 99% {{company.representativeName}} as Director / controlling shareholder and approximately 1% Shri Pal Kumawat, {{company.representativeName}}'s relative — brother-in-law) and {{var.mseName}} (Proprietorship wholly of {{company.representativeName}}).",
  "Until {{var.engagementStart}}, {{company.representativeName}} managed the Businesses almost entirely alone. From {{var.engagementStart}}, {{party.entityName}} began helping as a friend for about three months without remuneration, and the first-phase target of {{var.phase1Target}} by {{var.phase1End}} was achieved.",
  "From {{var.extensionStart}}, {{company.representativeName}} requested continued full operational and financial management by {{party.entityName}} toward a profit target of {{var.targetProfit}} by {{var.targetDate}}, while retaining all ownership and profit rights. This Agreement ends on {{var.targetDate}} whether or not that target is met; missing the target is acceptable to both Parties. {{party.entityName}}'s money cover applies to loss shortfalls under Clause 9, not to every normal Business loan while the Businesses are performing.",
  "{{party.entityName}} accepts full operational charge and the loss-shortfall cover as described herein, without partnership and without charging any fee. In return, {{party.entityName}} has asked that {{company.representativeName}} trust {{party.entityName}}, not scold or fight with {{party.entityName}}, accept {{party.entityName}}'s final call on disputed decisions, and work on soft skills, fitness, helping good people and caring for employees.",
];

const managementAuthorityPreamble =
  "NOW, THEREFORE, in consideration of the mutual promises and the trust reposed by {{company.representativeName}} in {{party.entityName}}, the Parties agree as follows:";
...
export function createDefaultAgreementData(
  ...
  if (template === "management-authority") {
    return {
      template: "management-authority",
      language: "en",
      title: "MANAGEMENT AUTHORITY AND OPERATIONAL CONTROL AGREEMENT",
      effectiveDate: today,
      company: defaultCompany(),
      party: {
        entityName: "",
      ...
      variableFields: managementAuthorityVariableFields,
      variables: { ...managementAuthorityVariableDefaults },
      introTemplate: managementAuthorityIntroTemplate,
      recitals: managementAuthorityRecitals,
      preambleAfterRecitals: managementAuthorityPreamble,
      sections: createManagementAuthoritySections(),
      closingParagraph: managementAuthorityClosing,
      governingLawParagraph: managementAuthorityGoverningLaw,
      partyIsIndividual: true,
      showPartyPan: true,
      showVendorChargePerWatt: false,
      vendorChargePerWatt: "",
