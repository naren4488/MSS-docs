...
export const FEATURE_NAV_ITEMS: FeatureNavItem[] = [
  ...
  },
  {
    ...
    label: "Enquiries",
    icon: PhoneCall,
    matchList: (pathname) => pathname === "/enquiries",
    matchMaker: (pathname) => pathname === "/enquiries",
  },
  {
    path: "/site-diagram",
    label: "Site Diagram",
    icon: Map,
    matchList: (pathname) => pathname === "/site-diagram" || pathname.startsWith("/site-diagram/"),
    matchMaker: (pathname) => pathname === "/site-diagram" || pathname.startsWith("/site-diagram/"),
  },
  {
    path: "/employees",
    label: "Employees",
